...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$sql = "SELECT username, firstname FROM Userss WHERE username = '$ausername' AND pw = '$apassword' AND level='M'";
	$result = mysqli_query($conn,$sql);
    $row = mysqli_fetch_array($result,MYSQLI_ASSOC);
    $count = mysqli_num_rows($result);  
    if($count == 1) {
       $_SESSION['loginmanager'] = $ausername;
...
<div class="content">
<center>
<h1>Please enter your manager username and password</h1>
