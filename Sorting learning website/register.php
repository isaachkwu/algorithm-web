...
<html>
  ...
  <?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = "INSERT INTO user (username,pw,email) VALUES ('$username','$password','$email')";
		...
		if(!$result){
			...
			echo "<script>
			alert('Account Creation successfully! Welcome to join us, " . $username . "! Please login again. ');
